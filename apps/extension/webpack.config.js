...
module.exports = {
  ...
  plugins: [
    ...
    new webpack.EnvironmentPlugin({
      ...
      WC_PROJECT_ID: "",
      KEPLR_EXT_EIP6963_PROVIDER_INFO_NAME: "Epix Wallet",
      KEPLR_EXT_EIP6963_PROVIDER_INFO_RDNS: "zone.epix.wallet",
      KEPLR_EXT_EIP6963_PROVIDER_INFO_ICON: keplrLogoBase64,
      KEPLR_EXT_STARKNET_PROVIDER_INFO_ID: "keplr",
      KEPLR_EXT_STARKNET_PROVIDER_INFO_NAME: "Epix Wallet",
