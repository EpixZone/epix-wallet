...
import { GWEI, IFeeConfig as IEVMFeeConfig } from "@keplr-wallet/hooks-evm";

export const EVMFeeSelector: FunctionComponent<{
      ...
      <Columns sum={3.6}>
          ...
          >
            ...
            <Box width="1px" alignX="center">
              ...
              <FeeSelectorStyle.Amount selected={feeConfig.type === "low"}>
                {(() => {
                  const fees = feeConfig.getEIP1559TxFees("low");
                  const gasPrice =
          ...
          >
            ...
            <Box width="1px" alignX="center">
              ...
              <FeeSelectorStyle.Amount selected={feeConfig.type === "average"}>
                {(() => {
                  const fees = feeConfig.getEIP1559TxFees("average");
                  const gasPrice =
                    fees.maxFeePerGas ?? fees.gasPrice ?? new Dec(0);
                  return `${gasPrice.quo(GWEI).toString(4)} GWEI`;
                })()}
          ...
          >
            ...
            <Box width="1px" alignX="center">
              ...
              <FeeSelectorStyle.Amount selected={feeConfig.type === "high"}>
                {(() => {
                  const fees = feeConfig.getEIP1559TxFees("high");
                  const gasPrice =
                    fees.maxFeePerGas ?? fees.gasPrice ?? new Dec(0);
                  return `${gasPrice.quo(GWEI).toString(4)} GWEI`;
                })()}
        ...
        <Column weight={0.6}>
          <FeeSelectorStyle.Item
            ...
            selected={feeConfig.type === "custom"}
          >
            <Box width="1px" alignX="center">
              <CustomIcon
                color={(() => {
...
const CustomIcon: FunctionComponent<{ color: string }> = ({ color }) => {
  return (
    <svg
