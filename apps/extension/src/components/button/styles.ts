...
> = {
    ...
    dark: {
      ...
      ghost: {
        ...
        disabled: css`
          ...
          ${makeTextAndSvgColor(ColorPalette["purple-700"])}
        `,
      },
    },
  },
  secondary: {
    ...
    dark: {
      fill: {
        enabled: css`
          background-color: ${ColorPalette["purple-800"]};
      ...
      ghost: {
        ...
        disabled: css`
          ...
          ${makeTextAndSvgColor(ColorPalette["gray-500"])}
        `,
      },
    },
  },
    ...
    dark: {
      ...
      ghost: {
        ...
        disabled: css`
          ...
          ${makeTextAndSvgColor(ColorPalette["red-700"])}
        `,
      },
    },
  },
