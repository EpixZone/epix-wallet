        ...
        if (
          ...
          if (currentFeeCurrencyBal.toDec().lt(currentFee.toDec())) {
            const isOsmosis = (() => {
              ...
              const u = chainStore.getModularChain(feeConfig.chainId).unwrapped;
              return (
                (u.type === "cosmos" || u.type === "ethermint") &&
                (u.cosmos.features?.includes("osmosis-txfees") ?? false)
              );
            })();
...
const SkipIcon: FunctionComponent<{
  ...
  return (
    <svg
      ...
      xmlnsXlink="http://www.w3.org/1999/xlink"
    >
      <rect width="192" height="192" fill="url(#pattern0_21303_50292)" />
      <defs>
        <pattern
          id="pattern0_21303_50292"
          patternContentUnits="objectBoundingBox"
          width="1"
          height="1"
        >
          <use xlinkHref="#image0_21303_50292" transform="scale(0.00520833)" />
        </pattern>
        <image
          id="image0_21303_50292"
          width="192"
          height="192"
          preserveAspectRatio="none"
          xlinkHref="data:image/png;base64,"
        />
      </defs>
    </svg>
  );
